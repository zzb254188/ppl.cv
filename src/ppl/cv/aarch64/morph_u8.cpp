...
inline void MorphRowLast(uint8x16_t &tprev, uint8x16_t &tcurr, uint8x16_t &tnext, const T *srcCenterRow, int32_t srcStride, T *drow, int32_t rowIdx, int32_t rowIdxInv, int32_t colIdx, int32_t colIdxInv, uchar borderValue = 0)
{
    ...
    switch (kernel_len) {
        case 3: {
            ...
            switch(lane){
                case 1:{t_last = vextq_u8(v_border, t_last,1); t_last = vextq_u8(t_last, v_border, 15);} break;
                case 2:{t_last = vextq_u8(v_border, t_last,2); t_last = vextq_u8(t_last, v_border, 14);} break;
                case 3:{t_last = vextq_u8(v_border, t_last,3); t_last = vextq_u8(t_last, v_border, 13);} break;
                case 4:{t_last = vextq_u8(v_border, t_last,4); t_last = vextq_u8(t_last, v_border, 12);} break;
                case 5:{t_last = vextq_u8(v_border, t_last,5); t_last = vextq_u8(t_last, v_border, 11);} break;
                case 6:{t_last = vextq_u8(v_border, t_last,6); t_last = vextq_u8(t_last, v_border, 10);} break;
                case 7:{t_last = vextq_u8(v_border, t_last,7); t_last = vextq_u8(t_last, v_border, 9);} break;
                case 8:{t_last = vextq_u8(v_border, t_last,8); t_last = vextq_u8(t_last, v_border, 8);} break;
                case 9:{t_last = vextq_u8(v_border, t_last,9); t_last = vextq_u8(t_last, v_border, 7);} break;
                case 10:{t_last = vextq_u8(v_border, t_last,10); t_last = vextq_u8(t_last, v_border, 6);} break;
                case 11:{t_last = vextq_u8(v_border, t_last,11); t_last = vextq_u8(t_last, v_border, 5);} break; 
                case 12:{t_last = vextq_u8(v_border, t_last,12); t_last = vextq_u8(t_last, v_border, 4);} break;
                case 13:{t_last = vextq_u8(v_border, t_last,13); t_last = vextq_u8(t_last, v_border, 3);} break;
                case 14:{t_last = vextq_u8(v_border, t_last,14); t_last = vextq_u8(t_last, v_border, 2);} break;
                case 15:{t_last = vextq_u8(v_border, t_last,15); t_last = vextq_u8(t_last, v_border, 1);} break;
                case 0:{} break;
                default:break;                
            }
            ...
            switch(lane){
                case 1:{t_res = vextq_u8(t_res, t_mid,1);} break;
                case 2:{t_res = vextq_u8(t_res, t_mid,2);} break;
                case 3:{t_res = vextq_u8(t_res, t_mid,3);} break;
                case 4:{t_res = vextq_u8(t_res, t_mid,4);} break;
                case 5:{t_res = vextq_u8(t_res, t_mid,5);} break;
                case 6:{t_res = vextq_u8(t_res, t_mid,6);} break;
                case 7:{t_res = vextq_u8(t_res, t_mid,7);} break;
                case 8:{t_res = vextq_u8(t_res, t_mid,8);} break;
                case 9:{t_res = vextq_u8(t_res, t_mid,9);} break;
                case 10:{t_res = vextq_u8(t_res, t_mid,10);} break;
                case 11:{t_res = vextq_u8(t_res, t_mid,11);} break; 
                case 12:{t_res = vextq_u8(t_res, t_mid,12);} break;
                case 13:{t_res = vextq_u8(t_res, t_mid,13);} break;
                case 14:{t_res = vextq_u8(t_res, t_mid,14);} break;
                case 15:{t_res = vextq_u8(t_res, t_mid,15);} break;
                case 0:{t_res = t_mid; lane = 16;} break;
                default:break;                
            }
