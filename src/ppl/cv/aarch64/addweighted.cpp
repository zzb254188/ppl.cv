    ...
    uint8_t *outData)
{
    ...
    for (int32_t i = 0; i < height; ++i) {
        int32_t j = 0;
        for (; j <= width - 8; j += 8) {
            uint16x8_t vdata0 = vmovl_u8(vld1_u8(inData0 + i * inWidthStride0 + j));
            ...
            uint16x8_t vdata1 = vmovl_u8(vld1_u8(inData1 + i * inWidthStride0 + j));
...
template <>
::ppl::common::RetCode AddWeighted<float, 1>(int32_t height, int32_t width, int32_t inWidthStride0, const float *inData0, float alpha, int32_t inWidthStride1, const float *inData1, float beta, float gamma, int32_t outWidthStride, float *outData)
{
...
template <>
::ppl::common::RetCode AddWeighted<float, 3>(int32_t height, int32_t width, int32_t inWidthStride0, const float *inData0, float alpha, int32_t inWidthStride1, const float *inData1, float beta, float gamma, int32_t outWidthStride, float *outData)
{
...
template <>
::ppl::common::RetCode AddWeighted<float, 4>(int32_t height, int32_t width, int32_t inWidthStride0, const float *inData0, float alpha, int32_t inWidthStride1, const float *inData1, float beta, float gamma, int32_t outWidthStride, float *outData)
{
...
template <>
::ppl::common::RetCode AddWeighted<uint8_t, 1>(int32_t height, int32_t width, int32_t inWidthStride0, const uint8_t *inData0, float alpha, int32_t inWidthStride1, const uint8_t *inData1, float beta, float gamma, int32_t outWidthStride, uint8_t *outData)
{
...
template <>
::ppl::common::RetCode AddWeighted<uint8_t, 3>(int32_t height, int32_t width, int32_t inWidthStride0, const uint8_t *inData0, float alpha, int32_t inWidthStride1, const uint8_t *inData1, float beta, float gamma, int32_t outWidthStride, uint8_t *outData)
{
...
template <>
::ppl::common::RetCode AddWeighted<uint8_t, 4>(int32_t height, int32_t width, int32_t inWidthStride0, const uint8_t *inData0, float alpha, int32_t inWidthStride1, const uint8_t *inData1, float beta, float gamma, int32_t outWidthStride, uint8_t *outData)
{
