...
void BM_Erode_ppl_aarch64(benchmark::State &state) {
    ...
    for (auto _ : state) {
        ppl::cv::aarch64::Erode<T, nc>(height, width, width * nc, src.get(), kernel_size, kernel_size, kernel.get(),                                
...
BENCHMARK_TEMPLATE(BM_Erode_ppl_aarch64, float, c1, k3x3)->Args({320, 240})->Args({640, 480})->Args({1280, 720})->Args({1920, 1080})->Args({3840, 2160});
BENCHMARK_TEMPLATE(BM_Erode_ppl_aarch64, float, c3, k3x3)->Args({320, 240})->Args({640, 480})->Args({1280, 720})->Args({1920, 1080})->Args({3840, 2160});
BENCHMARK_TEMPLATE(BM_Erode_ppl_aarch64, float, c4, k3x3)->Args({320, 240})->Args({640, 480})->Args({1280, 720})->Args({1920, 1080})->Args({3840, 2160});
BENCHMARK_TEMPLATE(BM_Erode_ppl_aarch64, float, c1, k5x5)->Args({320, 240})->Args({640, 480})->Args({1280, 720})->Args({1920, 1080})->Args({3840, 2160});
...
template<typename T, int32_t nc, int32_t kernel_size>
void BM_Erode_opencv_aarch64(benchmark::State &state) {
    int32_t width = state.range(0);
    int32_t height = state.range(1);
    std::unique_ptr<T[]> src(new T[width * height * nc]);
    std::unique_ptr<T[]> dst(new T[width * height * nc]);
    ...
    for (auto _ : state) {
        cv::erode(iMat, oMat, eleMat);
    }
    state.SetItemsProcessed(state.iterations() * 1);
}

BENCHMARK_TEMPLATE(BM_Erode_opencv_aarch64, float, c1, k3x3)->Args({320, 240})->Args({640, 480})->Args({1280, 720})->Args({1920, 1080})->Args({3840, 2160});
BENCHMARK_TEMPLATE(BM_Erode_opencv_aarch64, float, c3, k3x3)->Args({320, 240})->Args({640, 480})->Args({1280, 720})->Args({1920, 1080})->Args({3840, 2160});
BENCHMARK_TEMPLATE(BM_Erode_opencv_aarch64, float, c4, k3x3)->Args({320, 240})->Args({640, 480})->Args({1280, 720})->Args({1920, 1080})->Args({3840, 2160});
BENCHMARK_TEMPLATE(BM_Erode_opencv_aarch64, float, c1, k5x5)->Args({320, 240})->Args({640, 480})->Args({1280, 720})->Args({1920, 1080})->Args({3840, 2160});
