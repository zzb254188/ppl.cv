...
public:
    ...
    void apply(const MorphParam &param) {
        ...
        ppl::cv::aarch64::morph_f32<DilateVecOp, nc, kernel_size>(
            height,
            width,
            width * nc,
            src.get(),
...
// R1(Morph_u8c1, uint8_t, 1, 1.01)
// R1(Morph_u8c2, uint8_t, 2, 1.01)
// R1(Morph_u8c3, uint8_t, 3, 1.01)
// R1(Morph_u8c4, uint8_t, 4, 1.01)
